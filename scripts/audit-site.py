...
def main() -> None:
    ...
    assert "Áreas relacionadas aos temas documentados nesta ficha." in app, "impacto deve permanecer taxonômico e não valorativo"
    ...
    assert "O site não usa partido, profissão ou histórico para adivinhar posição." in app, "ficha deve explicitar limite contra inferência"
